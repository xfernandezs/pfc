...
gF:".row.flush{margin-left:0}.row.flush>*{padding:0!important}",gR:".row:after{content:'';display:block;clear:both;height:0}.row:first-child>*{padding-top:0}.row>*{padding-top:0}",gC:".row@{overflow-x:hidden;margin-left:0}.row@>*{float:none!important;width:100%!important;padding:10px 0 10px 0!important;margin-left:0!important}"},presets:{"default":{},standard:{breakpoints:{mobile:{range:"200-1300",lockViewport:!0,containers:"fluid",grid:{collapse:1}}}}},defaults:{breakpoint:{test:null,config:null,elements:null},config_breakpoint:{range:"",containers:960,lockViewport:!1,viewportWidth:!1,hasStyleSheet:!0,grid:{}}},DOMReady:null,getElementsByClassName:null,indexOf:null,iterate:null,extend:function(b,c){a.iterate(c,function(d){"object"==typeof c[d]?("object"!=typeof b[d]&&(b[d]={}),a.extend(b[d],c[d])):b[d]=c[d]})},parseMeasurement:function(a){var c;"string"!==typeof a?a=[a,"px"]:"fluid"==a?a=[100,"%"]:(c=a.match(/([0-9\.]+)([^\s]*)/),
